...
/**
 * Panel completo del admin del club: contenido pendiente de aprobar +
 * solicitudes pendientes de equipos + roster de equipos. `club` viene de
 * useClub() (onValue en tiempo real) — no hace falta refrescar a mano tras
 * aceptar/rechazar/quitar.
 */
